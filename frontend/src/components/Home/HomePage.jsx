...
const HeroSection = () => {
  return (
    <>
      <div className="bg-gradient-to-r from-violet-400 to-blue-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-white text-black font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
        </div>
      ...
      {/* Testimonials */}
      <div className="bg-violet-300 py-20 px-4">
        <h2 className="text-3xl font-bold text-center text-gray-800">
          What Our Users Say
        </h2>
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="mt-4 font-bold">- Stephanie Lopez</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <FaQuoteLeft className="text-xl text-gray-400" />
            <p className="mt-4">
            ...
            <p className="mt-4 font-bold">- Jenna Gilbert </p>
          </div>
        </div>
      </div>
      {/* CTA */}
      <div className="bg-purple-800 text-slate-50 py-20 px-4">
