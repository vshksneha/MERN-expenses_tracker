    ...
    <div className="flex flex-col items-center justify-center p-4">
      ...
      <form onSubmit={formik.handleSubmit} className="w-full max-w-xs">
        <div className="mb-4">
          ...
          <div className="flex items-center border-2 border-black bg-purple-200 py-2 px-3 rounded">
            ...
            <input
              ...
              className="outline-none flex-1 bg-transparent text-white placeholder-black"
        ...
        <button
          type="submit"
          className="w-full bg-violet-900 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded"
        >
          Update Password
        </button>
      </form>
