    ...
    <div className="bg-purple-200 min-h-screen py-10">
      <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                type="text"
                id="username"
                className="mt-1 block w-full border border-slate-700 rounded-md shadow-sm py-2 px-4 focus:outline-none focus:ring-blue-500 focus:border-blue-500 placeholder-slate-700"
          ...
          {/* Email Field */}
          <div className="flex items-center space-x-4">
            <FaEnvelope className="text-3xl black" />
            <div className="flex-1">
              <label
                htmlFor="email"
                className="text-sm font-medium text-black"
          ...
          <div className="flex justify-end mt-6">
            <button
              type="submit"
              className="bg-violet-900 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            >
              Save Changes
            </button>
          </div>
